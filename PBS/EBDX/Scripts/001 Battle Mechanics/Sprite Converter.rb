  ...
  def self.included base
    base.class_eval do
      ...
      def pbStartLoadScreen(*args)
        ...
        return loadSpriteConversion(*args) if !$DEBUG || Input.press?(Input::CTRL)
        ...
        unless files.empty? && !allFiles.include?("egg.png") && !allFiles.include?("eggCracks.png")
          Kernel.pbMessage("The game has detected that you have sprites in your Graphics/Battlers that do not match the Elite Battle: DX naming convention. This will break your game!")
          Kernel.pbMessage("Make sure you have made a copy of your Graphics/Battlers folder as automatically resolving the issue will make permanent changes.")
