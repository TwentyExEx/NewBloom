...
class PokeBattle_Scene
  ...
  def pbThrow(ball, shakes, critical, targetBattler, showplayer = nil)
    ...
    balltype = pbGetBallType(ball); ballframe = 0
    # sprites
    ...
    @sprites["captureball"].bitmap = BitmapCache.load_bitmap("Graphics/EBDX/Pictures/pokeballs")
    ...
    for i in 0...28
      @vector.set(EliteBattle.getVector(:ENEMY)) if i == 4
  ...
  def pbThrowSuccess
    ...
    pbBGMPlay("#{CAPTURE_BGM}") if !CAPTURE_BGM.nil?
