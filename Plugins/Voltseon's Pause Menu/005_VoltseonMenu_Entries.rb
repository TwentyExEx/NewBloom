...
class MenuEntryMap < MenuEntry # Play Pokémon Splice
	...
	def selectable?
		return $PokemonBag.pbHasItem?(:TOWNMAP)
	end
end
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# Entry for Encounter List screen by TheWelshOne
#-------------------------------------------------------------------------------
class MenuEntryEncounterList < MenuEntry
	...
	def selectable?
		return defined?(EncounterList_Scene)
	end
end
