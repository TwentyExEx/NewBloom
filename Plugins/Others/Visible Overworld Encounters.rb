#===============================================================================
# * Visible Overworld Encounters V2.0.2 for PEv18 - by derFischae (Credits if used please) *
#===============================================================================
#
...
def pbChooseTileOnStepTaken
  ...
  return if GameData::TerrainTag.try_get(map.terrain_tags[tile_id]).id == :Ice
  return if GameData::TerrainTag.try_get(map.terrain_tags[tile_id]).id == :Ledge
  return if GameData::TerrainTag.try_get(map.terrain_tags[tile_id]).id == :Waterfall
  return if GameData::TerrainTag.try_get(map.terrain_tags[tile_id]).id == :Rock
  return if GameData::TerrainTag.try_get(map.terrain_tags[tile_id]).id == :OWNoSpawn
  return if GameData::TerrainTag.try_get(map.terrain_tags[tile_id]).id == :SurfNoSpawn
  if RESTRICTENCOUNTERSTOPLAYERMOVEMENT
    return if !GameData::TerrainTag.try_get(map.terrain_tags[tile_id]).id == :Water && 
