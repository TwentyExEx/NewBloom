...
def pbDisplayNameWindow(msgwindow,dark,param)
  ...
  if dark==true
    namewindow.setSkin("Graphics/Windowskins/"+Settings::SPEECH_WINDOWSKINS[$PokemonSystem.textskin]+" xn dark")
    colortag=getSkinColor(msgwindow.windowskin,0,true)
    namewindow.text=colortag+namewindow.text
  else
    namewindow.setSkin("Graphics/Windowskins/"+Settings::SPEECH_WINDOWSKINS[$PokemonSystem.textskin]+" xn")
  end
...
def pbMessageDisplay(msgwindow,message,letterbyletter=true,commandProc=nil)
  ...
  text.gsub!(/\\[Pp][Gg]/,"\\b") if $Trainer && $Trainer.male?
  text.gsub!(/\\[Pp][Gg]/,"\\r") if $Trainer && $Trainer.female?
  text.gsub!(/\\[Pp][Oo][Gg]/,"\\r") if $Trainer && $Trainer.male?
  text.gsub!(/\\[Pp][Oo][Gg]/,"\\b") if $Trainer && $Trainer.female?
  text.gsub!(/\\[Pp][Gg]/,"")
  text.gsub!(/\\[Pp][Oo][Gg]/,"")
